...
const ProductDetails: React.FC = () => {
  ...
  return (
    <section className="relative w-full pt-44 pb-24 overflow-hidden">
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-30">
        {/* Left: Image Gallery */}
        <div>
          <div className="relative rounded-[10px]">
            ...
            <div className="relative w-full h-130 rounded-[10px]">
              <Image
                src={activeImage}
                alt="Product"
                fill
          ...
          <div className="mt-4 flex justify-between gap-4 px-4">
            {thumbnails.map((img, index) => (
              <button
                ...
                className={`relative w-22 h-22 overflow-hidden border cursor-pointer ${
        ...
        <div className="font-raleway">
          ...
          <p className="mt-6 text-[#979797] text-base font-light leading-relaxed max-w-xl">
            Experience culinary perfection with precision, sinshine. Hob offers
            sleek design, robust construction, and advanced features for
            effortless cooking.
          </p>
          ...
          {/* CTAs */}
          <div className="mt-30 pl-10 flex gap-20 flex-wrap">
