  ...
  return (
    <div className="w-full relative z-20">
      <div className="relative h-screen w-full">
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(8,10,12,1)_0%,rgba(8,10,12,1)_20%,rgba(8,10,12,1)_50%,rgba(8,10,12,1)_55%,rgba(8,10,12,1)_60%,rgba(8,10,12,0.9)_70%,rgba(8,10,12,0.7)_80%,rgba(8,10,12,0.2)_100%)] z-10"></div>

        <div className="flex flex-col md:flex-row h-full">
          {/* Left Side - Content */}
          <div className="absolute z-10 h-screen w-full">
            <div className="h-full max-w-6xl mx-auto flex flex-col items-start justify-center">
              {/* Shrink-wrap wrapper */}
              <div className="inline-block text-center">
                <h1 className="text-[68px] diamond-text leading-none font-semibold font-raleway">
                  Premium Kitchen
