  ...
  return (
    <div className=" w-full md:min-h-screen">
      <div className="md:h-screen w-full flex flex-col justify-center items-center">
        <h1 className="text-[36px] md:text-[68px] text-center diamond-text leading-none font-semibold font-raleway" data-aos="fade-down">
          Find us
        </h1>
        ...
        <section className="w-full md:pt-20 pt-5">
          <div className="max-w-6xl mx-auto px-4 md:px-0">
            <div className="relative w-full h-55.5 md:h-96 rounded-[40px] overflow-hidden shadow-2xl" data-aos="fade-up" data-aos-delay="200">
              <iframe
